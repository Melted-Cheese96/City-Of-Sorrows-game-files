...
def tavquesPath3():  # New combat system in play.
    thug = FirstClassThug()
    Fightoutcome = ['You strike the enemy with your weapon', 'you miss']
    ...
    if tavQues4 == 'fight':
        ...
        print('Checkpoint reached')
        sleep(1)
        ct.FightTesting(PlayerName, thug) #Change this back once done with Testing
...
def Backstory():
    story = open('City of sorrows lore', 'r')
    print(story.read())
    sleep(1)
    print('Starting game...')
    sleep(2)
